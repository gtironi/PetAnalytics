...
void setup()
{
  ...
  success &= (myICM_1.enableDMPSensor(INV_ICM20948_SENSOR_RAW_GYROSCOPE ) == ICM_20948_Stat_Ok);
  success &= (myICM_2.enableDMPSensor(INV_ICM20948_SENSOR_RAW_GYROSCOPE ) == ICM_20948_Stat_Ok);
  success &= (myICM_3.enableDMPSensor(INV_ICM20948_SENSOR_RAW_GYROSCOPE ) == ICM_20948_Stat_Ok);

  success &= (myICM_1.enableDMPSensor(INV_ICM20948_SENSOR_MAGNETIC_FIELD_UNCALIBRATED) == ICM_20948_Stat_Ok);
  success &= (myICM_2.enableDMPSensor(INV_ICM20948_SENSOR_MAGNETIC_FIELD_UNCALIBRATED) == ICM_20948_Stat_Ok);
  success &= (myICM_3.enableDMPSensor(INV_ICM20948_SENSOR_MAGNETIC_FIELD_UNCALIBRATED) == ICM_20948_Stat_Ok);
  ...
  success &= (myICM_3.setDMPODRrate(DMP_ODR_Reg_Accel, 0) == ICM_20948_Stat_Ok);

  success &= (myICM_1.setDMPODRrate(DMP_ODR_Reg_Gyro, 0) == ICM_20948_Stat_Ok);
  success &= (myICM_2.setDMPODRrate(DMP_ODR_Reg_Gyro, 0) == ICM_20948_Stat_Ok);
  success &= (myICM_3.setDMPODRrate(DMP_ODR_Reg_Gyro, 0) == ICM_20948_Stat_Ok);

  success &= (myICM_1.setDMPODRrate(DMP_ODR_Reg_Cpass, 0) == ICM_20948_Stat_Ok);
  success &= (myICM_2.setDMPODRrate(DMP_ODR_Reg_Cpass, 0) == ICM_20948_Stat_Ok);
  success &= (myICM_3.setDMPODRrate(DMP_ODR_Reg_Cpass, 0) == ICM_20948_Stat_Ok);
...
void loop()
{
  ...
  if ((myICM_1.status == ICM_20948_Stat_Ok) || (myICM_1.status == ICM_20948_Stat_FIFOMoreDataAvail)) // Was valid data available?
  {
    ...
    if ( (data_1.header & DMP_header_bitmap_Gyro) > 0 ) // Check for Gyro
    {
      float x_1 = (float)data_1.Raw_Gyro.Data.X; // Extract the raw gyro data
      float y_1 = (float)data_1.Raw_Gyro.Data.Y;
      float z_1 = (float)data_1.Raw_Gyro.Data.Z;

      // SERIAL_PORT.print(F("Gyro 1: X:"));
      // SERIAL_PORT.print(x_1);
      // SERIAL_PORT.print(F(" Y:"));
      // SERIAL_PORT.print(y_1);
      // SERIAL_PORT.print(F(" Z:"));
      // SERIAL_PORT.println(z_1);
    }

    if ( (data_1.header & DMP_header_bitmap_Compass) > 0 ) // Check for Compass
    {
      float x_gi_1 = (float)data_1.Compass.Data.X; // Extract the compass data
      float y_gi_1 = (float)data_1.Compass.Data.Y;
      float z_gi_1 = (float)data_1.Compass.Data.Z;

      // SERIAL_PORT.print(F("Compass 1: X:"));
      // SERIAL_PORT.print(x_gi_1);
      // SERIAL_PORT.print(F(" Y:"));
      // SERIAL_PORT.print(y_gi_1);
      // SERIAL_PORT.print(F(" Z:"));
      // SERIAL_PORT.println(z_gi_1);
    }
    }
  ...
  if ((myICM_2.status == ICM_20948_Stat_Ok) || (myICM_2.status == ICM_20948_Stat_FIFOMoreDataAvail)) // Was valid data available?
  {
    ...
    if ( (data_2.header & DMP_header_bitmap_Gyro) > 0 ) // Check for Gyro
    {
      float x_2 = (float)data_2.Raw_Gyro.Data.X; // Extract the raw gyro data
      float y_2 = (float)data_2.Raw_Gyro.Data.Y;
      float z_2 = (float)data_2.Raw_Gyro.Data.Z;

      // SERIAL_PORT.print(F("Gyro 2: X:"));
      // SERIAL_PORT.print(x_2);
      // SERIAL_PORT.print(F(" Y:"));
      // SERIAL_PORT.print(y_2);
      // SERIAL_PORT.print(F(" Z:"));
      // SERIAL_PORT.println(z_2);
    }

    if ( (data_2.header & DMP_header_bitmap_Compass) > 0 ) // Check for Compass
    {
      float x_gi_2 = (float)data_2.Compass.Data.X; // Extract the compass data
      float y_gi_2 = (float)data_2.Compass.Data.Y;
      float z_gi_2 = (float)data_2.Compass.Data.Z;

      // SERIAL_PORT.print(F("Compass 2: X:"));
      // SERIAL_PORT.print(x_gi_2);
      // SERIAL_PORT.print(F(" Y:"));
      // SERIAL_PORT.print(y_gi_2);
      // SERIAL_PORT.print(F(" Z:"));
      // SERIAL_PORT.println(z_gi_2);
    }
    }
  ...
  if ((myICM_3.status == ICM_20948_Stat_Ok) || (myICM_3.status == ICM_20948_Stat_FIFOMoreDataAvail)) // Was valid data available?
  {
    ...
    {
      float x_3 = (float)data.Raw_Gyro.Data.X; // Extract the raw gyro data
      float y_3 = (float)data.Raw_Gyro.Data.Y;
      float z_3 = (float)data.Raw_Gyro.Data.Z;

      // SERIAL_PORT.print(F("Gyro 3: X:"));
      // SERIAL_PORT.print(x_3);
      // SERIAL_PORT.print(F(" Y:"));
      // SERIAL_PORT.print(y_3);
      // SERIAL_PORT.print(F(" Z:"));
      // SERIAL_PORT.println(z_3);
    }

    if ( (data.header & DMP_header_bitmap_Compass) > 0 ) // Check for Compass
    {
      float x_gi_3 = (float)data.Compass.Data.X; // Extract the compass data
      float y_gi_3 = (float)data.Compass.Data.Y;
      float z_gi_3 = (float)data.Compass.Data.Z;

      // SERIAL_PORT.print(F("Compass 3: X:"));
      // SERIAL_PORT.print(x_gi_3);
      // SERIAL_PORT.print(F(" Y:"));
      // SERIAL_PORT.print(y_gi_3);
      // SERIAL_PORT.print(F(" Z:"));
      // SERIAL_PORT.println(z_gi_3);
    }
  }
}
